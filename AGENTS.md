...
This app must be deployed as the repo-root Databricks chat app. Do not infer a bundle-style deployment from `databricks.yml`. Do not deploy the `app/` directory; that is the Streamlit app, not the chat app.
